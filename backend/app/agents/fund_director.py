...
8. Ozon НЕ является портфельной компанией АФК (доля продана). НЕ включай Ozon в анализ текущего портфеля. Текущие активы: МТС, Segezha, Эталон, МЕДСИ, СТЕПЬ, Биннофарм, Cosmos Hotel Group, Natura Siberica"""
